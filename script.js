...
B  с помощью логического ИЛИ в условии проверьте, находится ли переменная n в диапазоне чисел от 0 до 100 включительно.
...
console.log(`Заработная плата ${user1.name} составляет ${user1.money} рублей`)
console.log(`Заработная плата ${user2.name} составляет ${user2.money} рублей`)
console.log(`Заработная плата ${user3.name} составляет ${user3.money} рублей`)
...
for(let property in numbers){
    console.log('Индекс ' + property + ' соответсвует число ' + numbers[property])
}
...
StringQuestion.push({usersAnswer: 'null'})
